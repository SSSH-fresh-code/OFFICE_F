...
export function SsshDataTableHeader({ info, children }: {
  info?: PageInfo;
...
export function SsshDataTablePagination({ info, href }: { info: PageInfo, href: string }) {
            ...
            [current - 1, current, current + 1]
              ...
              .map(i => (
                <PaginationItem
                  key={`page-${i}`}
                  className={
                    (i === current ? "bg-gray-200 font-bold" : "") + " rounded-md hover:bg-gray-200 p-0.5"
                  }
                >
