    ...
    <>
      <Card className="p-5 pt-3 bg-white bg-opacity-90">
        <div className="flex justify-end">
          <Button variant="link" onClick={() => { navigate({ to: "/user/" }) }}>목록</Button>
        </div>
        <CardHeader className="pt-0">
          <CardTitle className="w-full text-center text-2xl">회원 상세정보</CardTitle>
        </CardHeader>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="bg-white">
                    <SsshDropdownMenuItem
                      onClick={functions.moveToPostMade}
                    >
                      작성한 게시글보기
                    </SsshDropdownMenuItem>
                    <SsshDropdownMenuItem
                      onClick={functions.managePermission}
                    >
                      권한 수정하기
                    </SsshDropdownMenuItem>
                  </DropdownMenuContent>
